  ...
  <div class="animate-in slide-in-from-bottom duration-1000">
    ...
    <div class="z-form-header">
      <div class="flex items-center gap-4">
        ...
        <div>
          <h1 class="text-xl font-black text-white uppercase tracking-tighter leading-none">Implantar Unidade</h1>
          <p class="text-slate-400 text-[8px] font-black uppercase tracking-[0.2em] mt-1.5">Inicialização do Sistema</p>
        </div>
      </div>
